$X$ is ==**locally homeomorphic**== to $Y$ if for every $x\in X$, there exists a neighborhood $U\subset X$ of $x$ and a continuous map $\phi: U\to Y$ such that $\phi: U\to \phi(U)$ is a homeomorphism and $\phi(U)\subset Y$ is open.
