A continuous map $F:X\to Y$ between manifolds (of the same regularity class) is ==**regular**== if, for any regular function $h$ on an open set $U\subset Y$, the function $h\circ F$ on $F^{-1}(U)$ is regular.
