...
This is clear, because $[L_\alpha L_\beta] = L_{\alpha + \beta}$. This is why we have exactly the freedom to choose $\pi_\alpha$ with $\alpha \in \Delta$ in the below.
